    ...
    (run_dir / "artifact-ledger.md").write_text(
        "\n".join(
            [
                ...
                "## Review Summary",
                "",
                f"Generated-artifact status: {pass_status}. `paper/rail_demo.tex` is the compact paper source; compile and rendered-page inspection remain separate verification steps.",
            ]
        ),
        encoding="utf-8",
    )
