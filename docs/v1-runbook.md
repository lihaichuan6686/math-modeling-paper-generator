...
7. `docs/run-start-checklist.md`
8. `knowledge/cumcm/paper-generation-playbook.md`
9. `knowledge/cumcm/20-30-page-paper-blueprint.md`
10. `knowledge/algorithms/model-chain-patterns.md`
11. `knowledge/algorithms/cards/README.md`
12. relevant detailed algorithm cards under `knowledge/algorithms/cards/`
13. `docs/visual-generation-pipeline.md`
14. `knowledge/quality/quality-rubric-v2.md`
