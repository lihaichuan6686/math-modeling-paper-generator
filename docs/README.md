...
18. `paper-section-examples/README.md`
19. `run-artifact-index.md`
20. `project-audit-2026-07-06.md`
21. `architecture.md`
22. `long-term-roadmap.md`
23. `research-agenda.md`
24. `objective-coverage-matrix.md`
