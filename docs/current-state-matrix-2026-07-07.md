...
- The new `knowledge/cumcm/deep-reading-2021E014.md` note anchors the spectral/high-dimensional classification route with preprocessing-first modeling, feature reduction, classifier comparison, and confusion-level evaluation.
