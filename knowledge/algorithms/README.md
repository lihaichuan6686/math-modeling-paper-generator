...
7. `v1-6-method-chain-evidence-index.md`
8. `method-family-index.md`
9. `cards/README.md`
10. the detailed cards under `cards/`
...
For v1.6 runs, use `v1-6-method-chain-evidence-index.md` before coding and before drafting `paper/main.tex`. It rejects routes that have algorithm names but no paper-visible result artifact, validation artifact, or subquestion highlight.
...
- `v1-6-method-chain-evidence-index.md`
