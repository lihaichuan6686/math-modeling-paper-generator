...
| 2022 E014 | deep read complete | `knowledge/cumcm/deep-reading-2022E014.md` |
...
| 2024 C modern-draft risk reading | risk reading complete | `knowledge/cumcm/2024C-modern-draft-risk-reading.md` |
...
| ---: | --- | --- | --- |
| 1 | E-route archetype update | write the production/monitoring split into shared generator docs | archetype, blueprint, rubric updates |
...
- 2024 recent complete drafts: compare the modern risk notes against official concise styles and keep adding same-problem comparisons.
