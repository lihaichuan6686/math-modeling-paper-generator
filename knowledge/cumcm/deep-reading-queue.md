...
| ---: | --- | --- | --- |
| 1 | 2022 C155 | decision/planning with data | model chain, robustness checks |
| 2 | 2023 C050 | dynamic pricing/supply chain | forecast/evaluation/planning bridge |
| 3 | 2023 D039 | spatial optimization | geometry, visualization, validation |
| 4 | 2023 E176 | monitoring or data-analysis route | feature construction, validation, quality signals |
