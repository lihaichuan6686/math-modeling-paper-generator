...
| ---: | --- | --- | --- |
| 1 | 2021 E014 | spectral classification | preprocessing, feature extraction, classifier comparison |
| 2 | 2022 B030 | geometric/engineering or spatial route pattern | diagram density, formula-to-figure chain |
| 3 | 2022 C155 | decision/planning with data | model chain, robustness checks |
| 4 | 2023 C050 | dynamic pricing/supply chain | forecast/evaluation/planning bridge |
| 5 | 2023 D039 | spatial optimization | geometry, visualization, validation |
| 6 | 2023 E176 | monitoring or data-analysis route | feature construction, validation, quality signals |
