...
$checks = @(
    ...
    @{ File = "knowledge\quality\v1-5-hard-gates.md"; Patterns = @("Title Gate", "Abstract Gate", "Concept Figure Gate", "Result Sanity Gate", "Method Route Depth Gate", "v1.5-method-route-contract.md", "-Run .\runs\current", "-Tex .\paper\main.tex", "-Review .\reviews\review-current.md", "check-v1.5-pdf.ps1", "reviews/pdf-v15-check.md", "v1.5 Hard Gate Verdict") },
